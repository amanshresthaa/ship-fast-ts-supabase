...
import { ResponsiveContainer, MobileOnly, DesktopOnly } from "@/app/components/ResponsiveComponents";

const Hero = () => {
  const { isMobile, isTablet, isDesktop } = useResponsive();

  return (
    <ResponsiveContainer className="bg-base-100 flex flex-col lg:flex-row items-center justify-center gap-8 sm:gap-12 md:gap-16 lg:gap-20 py-8 sm:py-12 md:py-16 lg:py-20">
      <div className="flex flex-col gap-6 sm:gap-8 md:gap-10 lg:gap-14 items-center justify-center text-center lg:text-left lg:items-start">
        {/* Product Hunt Badge - Desktop/Tablet Only */}
        <DesktopOnly>
          <a
        ...
        <h1 className="font-extrabold text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl tracking-tight leading-tight sm:leading-tight md:leading-tight lg:leading-tight md:-mb-2 lg:-mb-4">
          Master Any Topic with Instant, Interactive Learning Mode Quizzes
        </h1>
        
        {/* Description with Responsive Sizing */}
        <p className="text-sm sm:text-base md:text-lg lg:text-xl opacity-80 leading-relaxed max-w-none sm:max-w-lg md:max-w-xl lg:max-w-2xl">
        ...
        <button 
          className={`
            btn btn-primary 
            ${isMobile ? 'btn-sm w-full' : 'btn-wide'} 
            ${isTablet ? 'btn-md' : ''} 
            ${isDesktop ? 'btn-lg' : ''}
          ...
          `}
        >
          {isMobile ? 'Start Quiz' : 'Start Your First Learning Quiz'}
        </button>
      ...
      <div className="w-full lg:w-1/2 xl:w-full">
        <Image
          ...
          alt="Product Demo"
          className="w-full h-auto rounded-lg sm:rounded-xl md:rounded-2xl shadow-lg sm:shadow-xl md:shadow-2xl"
          priority={true}
          width={500}
          height={500}
